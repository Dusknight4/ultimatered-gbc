...
; Characteristics of each move.
	...
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, FIGHTING,      95, 25
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,        85, 20
	move PAY_DAY,      PAY_DAY_EFFECT,              40, NORMAL,       100, 35
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           75, FIRE,         100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          75, ICE,          100, 15
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       75, ELECTRIC,     100, 15
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move VICEGRIP,     TRAPPING_EFFECT,             55, NORMAL,        90, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL,        75, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        75, NORMAL,        97, 30
	...
	move WRAP,         TRAPPING_EFFECT,             20, NORMAL,        90, 20
	...
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, BUG,          100, 25
	...
	move CLAMP,        TRAPPING_EFFECT,             35, WATER,         92, 20
	move SWIFT,        SWIFT_EFFECT,                60, NORMAL,       100, 20
	move SKULL_BASH,   CHARGE_EFFECT,              100, NORMAL,       100, 15
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  30, NORMAL,       100, 15
	...
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             30, BUG,          100, 20
	...
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        90, WATER,        100, 10
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         85, ROCK,          90, 10
