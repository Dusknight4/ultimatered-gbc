...
BrunoData:
	db $FF, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, RHYDON, 58, MACHAMP, 61, GOLEM, 0
...
Green3Data:
	db $FF, 64, PIDGEOT, 66, ALAKAZAM, 64, RHYDON, 65, ARCANINE, 65, EXEGGUTOR, 70, BLASTOISE, 0
	db $FF, 64, PIDGEOT, 66, ALAKAZAM, 64, RHYDON, 65, GYARADOS, 65, ARCANINE, 70, VENUSAUR, 0
	db $FF, 64, PIDGEOT, 66, ALAKAZAM, 64, RHYDON, 65, EXEGGUTOR, 65, GYARADOS, 70, CHARIZARD, 0

LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 58, BLASTOISE, 0
...
AgathaData:
	db $FF, 56, GENGAR, 56, GOLBAT, 55, HAUNTER, 58, ARBOK, 60, GENGAR, 65, ALAKAZAM, 0

LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, SEADRA, 62, AERODACTYL, 62, DRAGONITE, 65, CHARIZARD, 0
